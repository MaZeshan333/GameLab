...
class CloudWordBattle:
    ...
    def draw_rules(self):
        ...
        if self.current_rule_page == 0:
            ...
            items = ["🎮 SYSTEM INTERACTION", "", "🖱️ MOUSE COMMANDS:", "   • Left-Click specified column array to deploy targeted token.",
                     "", "⌨️ HARDWARE KEYBOARD:", "   • Input letters dynamically into your live input buffer.", "   • Press [ ENTER ] to evaluate and submit data.",
    ...
    def draw_mode_select(self):
        ...
        self.screen.blit(p_info, (SCREEN_WIDTH // 2 - p_info.get_width() // 2, 50))
        ...
        self.arcade_rect = pygame.Rect(SCREEN_WIDTH // 2 - 190, 180, 175, 240)
        self.practice_rect = pygame.Rect(SCREEN_WIDTH // 2 + 15, 180, 175, 240)
